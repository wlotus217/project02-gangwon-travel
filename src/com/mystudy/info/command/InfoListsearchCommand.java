...
public class InfoListsearchCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			//1. 전체 게시물 수량 구하기
			p.setTotalRecord(infoDAO.getsearchTotalCount(info));
			...
			List<infoVO> list = infoDAO.getInfoList(p.getBegin(), p.getEnd(), info);
			//===================================
			...
			return "infomationsearchlist.jsp";
