...
public class ContestlistCommand implements Command{
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//1. 전체 게시물 수량 구하기
		p.setTotalRecord(contestDAO.getTotalCount());
		p.setNumPerPage(4);
		p.setTotalPage();
		//2. 현재 페이지 구하기
		...
		List<contestVO> contlist = contestDAO.getList(p.getBegin(), p.getEnd());
