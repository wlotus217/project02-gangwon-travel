...
public class PlanListsearchCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			//1. 전체 게시물 수량 구하기
			p.setTotalRecord(planDAO.getsearchTotalCount(triptitle));
			p.setTotalPage();
			//2. 현재 페이지 구하기
			...
			List<planVO> list = planDAO.getPlanList(p.getBegin(), p.getEnd(), triptitle);
