...
public class NewsSearchListCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (keyword == null || keyword.equals("")) {
			...
			// 1. 전체 게시물 수량 구하기
			p.setTotalRecord(DAO.getSearchTotalCount(keyword));
			p.setTotalPage();
			...
			List<BbsVO> list = DAO.newsSearchPageList(String.valueOf(p.getBegin()), String.valueOf(p.getEnd()), keyword);
