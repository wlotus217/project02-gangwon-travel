...
public class NewsListCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 1. 전체 게시물 수량 구하기
		p.setTotalRecord(DAO.getNewsTotalCount());
		p.setTotalPage();
		...
		p.setEnd(p.getNowPage() * p.getNumPerPage() - DAO.anGetTotalCount());
		...
		List<BbsVO> list = DAO.newsList2(p.getBegin(), p.getEnd());
