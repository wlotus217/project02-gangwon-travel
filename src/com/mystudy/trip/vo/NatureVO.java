...
public class NatureVO {
	...
	public String toString() {
		return "NatureVO [boardNum=" + boardNum + ", title=" + title + ", contain=" + contain + ", fileName=" + fileName
				+ ", viewName1=" + viewName1 + ", viewName2=" + viewName2 + ", viewName3=" + viewName3 + ", address="
				+ address + ", pay=" + pay + ", phone=" + phone + ", time=" + time + ", writeDate=" + writeDate
				+ ", hit=" + hit + "]";
	}
