...
public class hiddenSearchCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//1. 전체 게시물 수량 구하기
		p.setTotalRecord(DAO.hiddenSearchTotalCount(search, searchKeyword)); 
		p.setTotalPage();
		...
		List<HiddenVO> searchList = DAO.hiddenSearchList(String.valueOf(p.getBegin()), String.valueOf(p.getEnd()), search, searchKeyword);
