...
public class natureSearchCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 1. 전체 게시물 수량 구하기
		p.setTotalRecord(DAO.natureSearchTotalCount(search, searchKeyword));
		p.setTotalPage();
		...
		List<NatureVO> searchList = DAO.natureSearchList(String.valueOf(p.getBegin()),
				String.valueOf(p.getEnd()), search, searchKeyword);
