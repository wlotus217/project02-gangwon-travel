...
public class experienceListCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	//페이징 처리를 위한 객체(Paging) 생성
       	...
       	//1. 전체 게시물 수량 구하기
       	p.setTotalRecord(DAO.experienceTotalCount()); 
       	p.setTotalPage();
       	...
       	List<ExperienceVO> list = DAO.experienceList(p.getBegin(), p.getEnd());
