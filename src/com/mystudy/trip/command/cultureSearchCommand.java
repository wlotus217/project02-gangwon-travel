...
public class cultureSearchCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 1. 전체 게시물 수량 구하기
		p.setTotalRecord(DAO.cultureSearchTotalCount(search, searchKeyword));
		p.setTotalPage();
		...
		List<CultureVO> searchList = DAO.cultureSearchList(String.valueOf(p.getBegin()), String.valueOf(p.getEnd()),
