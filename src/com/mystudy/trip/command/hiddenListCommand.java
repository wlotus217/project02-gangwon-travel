...
public class hiddenListCommand implements Command {
	...
	public String exec(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//1. 전체 게시물 수량 구하기
		p.setTotalRecord(DAO.hiddenTotalCount()); 
		System.out.println(DAO.hiddenTotalCount());
		p.setTotalPage();
		...
		List<HiddenVO> list = DAO.hiddenList(p.getBegin(), p.getEnd());
