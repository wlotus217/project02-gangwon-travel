		...
		<div class="row">
			...
			<div class="col-10">
				...
				<div class="py-5 ">
					...
					<form class="form"
						action="${pageContext.request.contextPath }/controller3?type=themeModify&idx=${tvo.idx}"
						method="post" enctype="multipart/form-data">
						<div class="form-group row">
							<label for="Input1" class="col-sm-2 col-form-label">제목</label>
							<div class="col-sm-10">
								<input type="text" name="title" title="제목" value="${tvo.title }"
									class="form-control">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="intro" title="소개글"
									id="Textarea1" rows="5">${tvo.intro }</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="placeName1" title="장소명1"
									value="${tvo.placeName1}" class="form-control">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="detail1" title="장소1 상세"
									id="Textarea2" rows="8">${tvo.detail1 }</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="file" class="form-control-file" name="image1"
									value="${tvo.image1}" title="장소1 이미지" id="File1">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="placeName2" title="장소명2"
									value="${tvo.placeName2}" class="form-control">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="detail2" title="장소2 상세"
									id="Textarea2" rows="8">${tvo.detail2 }</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="file" class="form-control-file" name="image2"
									value="${tvo.image2}" title="장소2 이미지" id="File1">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="placeName3" title="장소명3"
									value="${tvo.placeName3}" class="form-control">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="detail3" title="장소3 상세"
									id="Textarea2" rows="8">${tvo.detail3 }</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="file" class="form-control-file" name="image3"
									value="${tvo.image3}" title="장소3 이미지" id="File1">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="placeName4" title="장소명4"
									value="${tvo.placeName4}" class="form-control">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="detail4" title="장소4 상세"
									id="Textarea2" rows="8">${tvo.detail4 }</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="file" class="form-control-file" name="image4"
									value="${tvo.image4}" title="장소4 이미지" id="File1">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" name="placeName5" title="장소명5"
									value="${tvo.placeName5}" class="form-control">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="detail5" title="장소5 상세"
									id="Textarea2" rows="8">${tvo.detail5 }</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="file" class="form-control-file" name="image5"
									value="${tvo.image5}" title="장소5 이미지" id="File1">
							</div>
						</div>
