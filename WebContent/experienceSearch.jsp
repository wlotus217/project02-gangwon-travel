<%@page import="com.mystudy.trip.vo.ExperienceVO"%>
...
<div class="col-10">		
	...
	<div class="row p-1 my-3 border">
		...
		<div class="col-8">
			<form class="form-inline float-right" action="controller2?type=experienceSearch" method="post">
	...
	<div class="row border-bottom ">
		<form class="form-inline" action="experienceUpload.jsp">
	...
	<div class="row py-5 ">
	    		...
	    		<c:forEach var="vo" items="${list }">
		    		<div class="col">
			    			<div class="card" style="width: 18rem;">
			  				<a href="controller2?type=experienceView&boardNum=${vo.boardNum }"><img src="images/experience/${vo.fileName }" class="card-img-top" alt="..."></a>
			  				<div class="card-body">
			...
			<div class="row row-cols-3 text-center" style="<c:if test='${empty searchList }'>display:none;</c:if>">			
	    		<c:forEach var="svo" items="${searchList }">
		    		<div class="col">
			    			<div class="card" style="width: 18rem;">
			  				<a href="controller2?type=experienceView&boardNum=${svo.boardNum }"><img src="images/experience/${svo.fileName }" class="card-img-top" alt="..."></a>
			  				<div class="card-body">
	...
	<div id="list" class="row">
		<input class="btn btn-secondary" type="button" value="목록보기" onclick="javascript:location.href='controller2?type=experienceList'">
	</div>
	...
	<div class="p-5">
		<nav aria-label="Page navigation example">
	  		<ul class="pagination justify-content-center">
		    	...
		    	<c:if test="${pvo.beginPage != 1 }">
					<li>
						<a class="page-link" href="controller2?type=experienceList&cPage=${pvo.begin - 1 }">Previous</a>
					</li>
				</c:if>	
				...
				<c:forEach var="pageNo" begin="${pvo.beginPage }" end="${pvo.endPage }">
					...
					<c:if test="${pageNo != pvo.nowPage }">
						<li class="page-item">
							<a class="page-link" href="controller2?type=experienceList&cPage=${pageNo }">${pageNo }</a>
						</li>
					</c:if>
				</c:forEach>
				...
				<c:if test="${pvo.endPage < pvo.totalPage }">
				    <li class="page-item">
		      			<a class="page-link" href="controller2?type=experienceList&cPage=${pvo.endPage + 1 }">Next</a>
		    		</li>
		    	</c:if>
		    	<c:if test="${pvo.endPage >= pvo.totalPage }">
					<li class="page-item disabled">
