	...
	<div class="p-5">
		<nav aria-label="Page navigation example">
	  		<ul class="pagination justify-content-center">
		    	...
		    	<c:if test="${pvo.beginPage != 1 }">
					<li>
						<a class="page-link" href="controller2?type=hiddenList&cPage=${pvo.begin - 1 }">Previous</a>
					</li>
				</c:if>	
				...
				<c:forEach var="pageNo" begin="${pvo.beginPage }" end="${pvo.endPage }">
					...
					<c:if test="${pageNo != pvo.nowPage }">
						<li class="page-item">
							<a class="page-link" href="controller2?type=hiddenList&cPage=${pageNo }">${pageNo }</a>
						</li>
					</c:if>
				</c:forEach>
				...
				<c:if test="${pvo.endPage < pvo.totalPage }">
				    <li class="page-item">
		      			<a class="page-link" href="controller2?type=hiddenList&cPage=${pvo.endPage + 1 }">Next</a>
		    		</li>
		    	</c:if>
		    	<c:if test="${pvo.endPage >= pvo.totalPage }">
					<li class="page-item disabled">
