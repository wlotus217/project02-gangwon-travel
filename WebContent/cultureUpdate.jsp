...
<script>
	...
	function list_go() {
		location.href = "controller2?type=cultureList";
	}
</script>
</head>
<body>
...
<!-- 페이지 제목 -->
	...
	<!-- 진짜 내용 -->
	<div class="py-5">
		<form class="form" action="controller2?type=cultureUpdateOk&boardNum=${vo.boardNum }" method="post" enctype="multipart/form-data">
