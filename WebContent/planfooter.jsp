<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<footer class="bg-light" style="margin-top: 300px;">
	<div class="container">
		
	<br>
	<div class="row py-3" >
		<a href="#" class="btn btn-outline-secondary mr-2" role="button" aria-pressed="true">개인정보처리방침</a>
		<a href="#" class="btn btn-outline-secondary mr-2" role="button" aria-pressed="true">영상정보처리기기관리방침</a>
		<a href="#" class="btn btn-outline-secondary mr-2" role="button" aria-pressed="true">저작권보호</a>
	</div>
	<div class="row my-3">
		<div style="text-align: left;"><h6>(우 24266) 강원도 춘천시 중앙로 1 (봉의동)</h5><h5>Copyright &copy; Gangwon-do. All Rights reserved.</h6></div>
	
	</div>
	<div class="row">
		<div class="col-6">
			<img src="${pageContext.request.contextPath }/imgs/logo.png" height="60">
		</div>
