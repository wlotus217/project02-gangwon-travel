...
<div class="col-10">		
	...
	<div class="row p-1 my-3 border">
		...
		<div class="col-8">
			<form class="form-inline float-right" action="controller2?type=natureSearch" method="post">
	...
	<div class="row border-bottom ">
		<form class="form-inline" action="natureUpload.jsp">
	...
	<div class="row py-5 ">
	    		...
	    		<c:forEach var="vo" items="${list }">
		    		<div class="col">
			    			<div class="card" style="width: 18rem;">
			  				<a href="controller2?type=natureView&boardNum=${vo.boardNum }"><img src="images/nature/${vo.fileName }" class="card-img-top" alt="..."></a>
			  				<div class="card-body">
			...
			<div class="row row-cols-3 text-center" style="<c:if test='${empty searchList }'>display:none;</c:if>">			
	    		<c:forEach var="svo" items="${searchList }">
		    		<div class="col">
			    			<div class="card" style="width: 18rem;">
			  				<a href="controller2?type=natureView&boardNum=${svo.boardNum }"><img src="images/nature/${svo.fileName }" class="card-img-top" alt="..."></a>
			  				<div class="card-body">
	...
	<div class="p-5">
		<nav aria-label="Page navigation example">
	  		<ul class="pagination justify-content-center">
		    	...
		    	<c:if test="${pvo.beginPage != 1 }">
					<li>
						<a class="page-link" href="controller2?type=natureList&cPage=${pvo.begin - 1 }">Previous</a>
					</li>
				</c:if>	
				...
				<c:forEach var="pageNo" begin="${pvo.beginPage }" end="${pvo.endPage }">
					...
					<c:if test="${pageNo != pvo.nowPage }">
						<li class="page-item">
							<a class="page-link" href="controller2?type=natureList&cPage=${pageNo }">${pageNo }</a>
						</li>
					</c:if>
				</c:forEach>
				...
				<c:if test="${pvo.endPage < pvo.totalPage }">
				    <li class="page-item">
		      			<a class="page-link" href="controller2?type=natureList&cPage=${pvo.endPage + 1 }">Next</a>
		    		</li>
		    	</c:if>
		    	<c:if test="${pvo.endPage >= pvo.totalPage }">
					<li class="page-item disabled">
