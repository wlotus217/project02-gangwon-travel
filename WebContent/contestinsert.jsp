...
<!-- 내용 -->
<div id="contest">
	<form action="controller4?type=contestinsert" method="post" enctype="multipart/form-data">
	<table style="margin-left: 25%; font-family: 'Jua', sans-serif;">
		<tbody>
			<tr>
				<th>제목</th>
				<td><input type="text" name="picTitle" style="border: none; float: left; width: 100%;"></td>
			</tr>
			<tr>
				<th>사진</th>
			...
			<tr>
				<td colspan="2">
					<textarea name="picContent" rows="5" cols="60" style="border: none; width: 100%;"></textarea>
				</td>
			</tr>
		</tbody>
		<tfoot>
