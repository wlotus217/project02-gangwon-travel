...
function deleteData() {
	if (confirm("삭제하시겠습니까?")) {
	location.href = "controller2?type=experienceDelete&boardNum=${vo.boardNum }";
	}
}
...
<!-- 페이지 제목 -->	
	...
	<div class="row border-bottom ">
		<form class="form-inline">
			<input class="btn btn-secondary" type="button" value="수 정" onclick="javascript:location.href='controller2?type=experienceUpdate&boardNum=${vo.boardNum }'" style="margin-right: 2px;">
		</form>		
		<form class="form-inline">
