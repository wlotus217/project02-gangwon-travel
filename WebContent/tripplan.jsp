		...
		<div style="width: 100%;">
			<div style="width: 50%; height: 600px; float: left;">
				<form action="controller4" method="post">
					<h3
						style="margin-top: 20px; margin-left: 25%; font-family: 'Jua', sans-serif;">여행일정
						만들기</h3>
					<hr>
					<h3 style="margin-top: 20px; font-family: 'Jua', sans-serif;">
						여행제목 : <input type="text"
							style="width: 500px; height: 32px; font-size: 15px; border: 0; border-radius: 15px; outline: none; padding-left: 10px; background-color: rgb(233, 233, 233);"
							name="triptitle" placeholder="여행제목을 입력해주세요.">
					</h3>
					<hr>
					<h3 style="font-family: 'Jua', sans-serif;">여행지역</h3>
					<select name="region" title="여행지역"
					...
					<select name="purpose" title="여행목적"
						style="width: 300px; text-align: center;">
					...
					<hr>
					<h5 style="font-weight: bold; font-family: 'Jua', sans-serif;">1일차
						동선</h5>
					<input type="text" name="day1"
						style="width: 600px; font-family: 'Jua', sans-serif;">
					<hr>
					<h5 style="font-weight: bold; font-family: 'Jua', sans-serif;">2일차
						동선</h5>
					<input type="text" name="day2"
						style="width: 600px; font-family: 'Jua', sans-serif;">
					<hr>
					<h5 style="font-weight: bold; font-family: 'Jua', sans-serif;">3일차
						동선</h5>
					...
					<c:if test="${not empty ch.id}">
						<input type="submit" value="저장하기"
							style="width: 500px; height: 32px; font-size: 15px; border: 0; border-radius: 15px; outline: none; padding-left: 10px; background-color: rgb(233, 233, 233); margin-left: 10%;">
						<input type="hidden" name="type" value="insertplan">
					</c:if>
				</form>
				<input type="button" value="목록으로 돌아가기" onclick="tripplanlist_go()"
					style="width: 500px; height: 32px; font-size: 15px; border: 0; border-radius: 15px; outline: none; padding-left: 10px; background-color: rgb(233, 233, 233); margin-left: 10%; margin-top: 30px;">
			</div>
			<div style="margin-left: 50%; height: 600px;">
				<div class="map" id="map"
					style="height: 900px; cursor: url(https://t1.daumcdn.net/mapjsapi/images/cursor/openhand.cur.ico) 7 5, url(https://t1.daumcdn.net/mapjsapi/images/cursor/openhand.cur.ico), default;"></div>
