...
System.out.println("================");
System.out.println(">> ans_del.jsp commentIdx : " + commentIdx);
				...
				<div class="row py-5 ">
					...
					<div id="contents">
						...
						<div>
							...
							<hr>
							<p>
								<a href="list.jsp">[게시글로 이동(미완)]</a>
							</p>

							<form action="ans_del_ok.jsp" method="get">
								<table>
									<tr>
										<th>비밀번호</th>
										<td><input type="text" name="pwd"> <input
											type="submit" value="삭 제"> <input type="hidden"
											name="commentIdx" value="${cvo.commentIdx }"></td>
									</tr>
								</table>
							</form>
						</div>
