	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-10">
				...
				<div class="py-5">
					<form class="form"
						action="${pageContext.request.contextPath }/controller3?type=courseModify&idx=${cvo.idx}"
						method="post" enctype="multipart/form-data">
						<div class="form-group row">
							<label for="Input1" class="col-sm-2 col-form-label">제목</label>
							<div class="col-sm-10">
								<input type="text" name="title" title="제목" value="${cvo.title }"
									class="form-control">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="intro" title="소개글"
									id="Textarea1" rows="5">${cvo.intro }</textarea>
							</div>
						</div>
						<div class="form-group row">
							<label for="File1" class="col-sm-2 col-form-label">썸네일
								이미지</label>
							<div class="col-sm-10">
								<input type="file" class="form-control-file" name="image"
									title="썸네일 이미지" value="${cvo.image }" id="File1">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="day1" title="1일차"
									id="Textarea2" rows="3">${cvo.day1 }</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="day2" title="2일차"
									id="Textarea3" rows="3">${cvo.day2 }</textarea>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="day3" title="3일차"
									id="Textarea4" rows="3">${cvo.day3 }</textarea>
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-10">
