...
<body>
	<!-- navbar -->
		<%@ include file="mypagemainnav4.jspf"%>
					...
					<div class="input-form-backgroud row">
						<div class="input-form col-md-12 mx-auto">
							<div id="wrap">
								...
								<hr>
								<form action="controller?type=updateMember&id=${ch.id }" class="validation-form" method="post">
									<!-- 비밀번호 -->
									<div class="mb-3">
									...
									<div class="mb-3">
										<label for="user_phone">휴대전화 ('-' 없이 번호만 입력해주세요)</label> <input
											...
											name="phone" value="${ch.phone }" required>
									...
									<div class="mb-3">
										<label for="user_email">이메일</label> <input type="text"
											...
											value="${ch.email }" required>
										<div class="check_font" id="email_check"></div>
									</div>
									<div class="reg_button text-center">
										<a class="btn btn-danger  px-3" href="mypage.jsp">
										<i class="fa fa-rotate-right pr-2"></i>취소하기
										</a>&emsp;&emsp;
										<button class="btn btn-primary px-3" id="reg_submit">
											<i class="fa fa-heart pr-2"></i>저장하기
										</button>
									</div>
								</form>
							</div>
