...
<script>
	...
	function list_go() {
		location.href = "controller2?type=hiddenList";
	}
</script>
</head>
<body>
...
<!-- 페이지 제목 -->
	...
	<!-- 진짜 내용 -->
	<div class="py-5">
		<form class="form" action="controller2?type=hiddenUpdateOk&boardNum=${vo.boardNum }&id=${vo.id}" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group row">
		    <label for="File1" class="col-sm-2 col-form-label">이미지</label>
		    <div class="col-sm-10">
		    <input type="file" class="form-control-file" name="fileName" title="이미지" id="File1">
		    </div>
		  </div>
